        ...
        <table className="min-w-[1200px] w-full bg-white border border-gray-200 rounded-lg shadow-md whitespace-nowrap">
          <thead className="bg-blue-gray-500 border-b w-full">
            ...
            <th className="px-4 py-2 text-center text-xs font-medium text-white uppercase tracking-wider">#</th>
              ...
              <th className="px-4 py-2 text-center text-xs font-medium text-white uppercase tracking-wider">Date Prise Energie</th>
              <th className="px-4 py-2 text-center text-xs font-medium text-white uppercase tracking-wider">Date Energie</th>
              <th className="px-4 py-2 text-center text-xs font-medium text-white uppercase tracking-wider">Heure Energie</th>
          ...
          {filteredEnergies.slice().reverse().map((Energie, index) => (
              ...
              <td className="px-4 py-3 text-sm text-gray-700 text-center">{filteredEnergies.length - index}</td>
                ...
                <td className="px-4 py-3 text-sm text-gray-700">{Energie.datePriseEnergie}</td>
                <td className="px-4 py-3 text-sm text-gray-700">{Energie.dateEnergie}</td>
                <td className="px-4 py-3 text-sm text-gray-700">{Energie.heureEnergie}</td>
            ...
            {!isEditing ? (
              ...
              <span className={`${selectedEnergie.EnergieType === 'Physique' ? 'text-green-500' : selectedEnergie.EnergieType === 'Téléphonique' ? 'text-blue-700' :selectedEnergie.EnergieType === 'Siège' ? 'text-orange-700' : 'text-gray-700'}`}>
               {selectedEnergie.EnergieType}
                ...
                <p className="text-left"><strong>Date prise Energie:</strong> {selectedEnergie.datePriseEnergie}</p>
                <p className="text-left"><strong>Date Energie :</strong> {selectedEnergie.dateEnergie}</p>
                <p className="text-left"><strong>Heure Energie :</strong> {selectedEnergie.heureEnergie}</p>
              ...
              <>
                ...
                <label className="block mb-2">
                  ...
                  <label className="block mb-2">
                    <span className="text-gray-700">Date prise Energie :</span>
                    <input
                      name="datePriseEnergie"
                      value={formData.datePriseEnergie}
                      onChange={handleInputChange}
                      className="block w-full mt-1 border-gray-300 rounded-md shadow-sm"
                    />
                  </label>
                  <label className="block mb-2">
                    <span className="text-gray-700">Date Energie :</span>
                    <input
                      name="dateEnergie"
                      value={formData.dateEnergie}
                      onChange={handleInputChange}
                      className="block w-full mt-1 border-gray-300 rounded-md shadow-sm"
                    />
                  </label>
                  <label className="block mb-2">
                    <span className="text-gray-700">Heure Energie :</span>
                    <input
                      name="heureEnergie"
                      value={formData.heureEnergie}
                      onChange={handleInputChange}
                      className="block w-full mt-1 border-gray-300 rounded-md shadow-sm"
                    />
                  </label>
