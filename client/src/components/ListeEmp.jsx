    ...
    <div className="max-w-7xl mx-auto p-6 bg-gray-50 rounded-lg shadow-lg">
      <div className="overflow-x-auto">
        ...
        '••••••••'
                ...
                <td className="px-4 py-3 text-sm text-gray-700">
                {(user.role === "Gestionnaire" || user.role === "Commerciale" || user.role === "Manager" || user.role === "Prise" || user.role === "ManagerOPCO" || user.role === "CommercialeOPCO(A)" || user.role === "CommercialeOPCO(B)" || user.role === "CommercialeVente(A)" || user.role === "CommercialeVente(B)" || user.role === "superviseur-OPCO") && (
                  <Switch
                    checked={user.etat === 1}
